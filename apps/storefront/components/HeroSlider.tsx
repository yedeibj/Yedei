  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* Texte */}
        <div className="order-2 flex flex-col justify-center px-6 py-12 sm:px-12 sm:py-16 lg:order-2 lg:px-16">
          {activeSlide.eyebrow && (
         ...
         {/* Image */}
<div className="relative order-1 aspect-[9/16] w-full overflow-hidden bg-[#181715] sm:aspect-[3/4] lg:order-1 lg:aspect-auto lg:h-[85vh]">
  {heroSlides.map((slide, i) => (
    <img
      key={slide.id}
      src={slide.image}
